...
subtitlesT.setSubtitle(mission2.player1, "Go to Michelle's garage and get #3232FFthe vehicle.", 10000)
...
subtitlesT.setSubtitle(mission2.player2, "Go to Easter Basin docks and get #3232FFa Packer.", 10000)
...
local rgbString=string.format("%02X%02X%02X", getPlayerNametagColor( mission2.player2 ))
subtitlesT.setSubtitle(mission2.player1, "Wait for #"..rgbString..getPlayerName(mission2.player2).." #FFFFFFto park the Packer.", 10000)
...
subtitlesT.setSubtitle(mission2.player2, "Park the Packer in front of #32FF32the Driving School gates.", 10000)
...
local rgbString=string.format("%02X%02X%02X", getPlayerNametagColor( mission2.player1 ))
subtitlesT.setSubtitle(mission2.player2,"Allow #"..rgbString..getPlayerName(mission2.player1).." #FFFFFFto jump the gate using the Packer.",10000)
local rgbString=string.format("%02X%02X%02X", getPlayerNametagColor( mission2.player2 ))
subtitlesT.setSubtitle(mission2.player1,"Jump over the gate using #"..rgbString.."the Packer.",10000)
mission2.jumpmarker=createMarker(-2046.4,-120.7,34,"cylinder",5,15,190,60,100,mission2.player1)
...
subtitlesT.setSubtitle(mission2.player1,"Get in #3232FFthe vehicle.",10000)
...
local rgbString=string.format("%02X%02X%02X", getPlayerNametagColor( mission2.player1 ))
subtitlesT.setSubtitle(mission2.player2,"Follow #"..rgbString..getPlayerName(mission2.player1).."#FFFFFF back to the car dealership..",10000)
subtitlesT.setSubtitle(mission2.player1,"Use the ramp to jump out of the driving school grounds.\nDon't go too fast!",10000)
mission2.getoutmarker=createMarker(-2027.3,-95.1,34.5,"cylinder",4,15,190,60,100,mission2.player1)
...
subtitlesT.setSubtitle(mission2.player1,"Go back to #0FBE3Cthe car dealership.\n#FFFFFFMake sure you don't damage the car too much!",10000)
